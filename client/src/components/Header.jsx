            ...
            <header className="text-gray-600 body-font">
                <div className="container z-50 border-b-2 shadow-md  mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        ...
                        {/* <svg xmlns={img} fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                        ...
                        <Link to="/detection" className="mr-5 hover:text-gray-900 cursor-pointer cursor: pointer;"  >Detection</Link>
                        <Link to="/table" className="mr-5 hover:text-gray-900 cursor-pointer cursor: pointer;"  >Table</Link>
                        <Link to="/cattle" className="mr-5 hover:text-gray-900 cursor-pointer cursor: pointer;"  >Cattle</Link>
                        <Link to="/graph" className="mr-5 hover:text-gray-900 cursor-pointer cursor: pointer;"  >Graph</Link>
                        {Object.keys(loginStatus).length > 0 ?
                            <div>
                                <div className="inline-flex overflow-hidden relative justify-center items-center w-10 h-10 bg-gray-100 rounded-full dark:bg-gray-600">
                                    <span className="font-medium text-gray-600 dark:text-gray-300">{loginStatus.name[0].toUpperCase()}</span>
                                </div>
                                <button onClick={() => { setLoginStatus({}); navigate("/"); }} className="inline-flex items-center bg-gray-100 border-0 py-1 px-2 ml-4 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Log Out
