    ...
    return (
        <section className="text-gray-600 body-font">
            ...
            <div className="container px-1 py-0 mx-auto">
                <button className="flex mx-auto text-white bg-indigo-500 border-0 px-6 my-20 py-1 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={() => { props.setData({}); navigate("/cattle"); }}>Back</button>
            </div>
        </section>
    )
}